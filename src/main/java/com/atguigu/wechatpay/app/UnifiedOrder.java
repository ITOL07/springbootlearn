...
//	private static final Logger logger = Logger.getLogger(UnifiedOrder.class);
	...
	public static Map<String, Object> weixinPrePay(String sn,
        ...
        parameterMap.put("openid", CustConsts.OPENID);
...
//			parameterMap2.put("partnerid", mchId);
			...
			parameterMap2.put("package", "prepayid="+prepayid);
...
//			resMap.put("package", "Sign=WXPAY");
            resMap.put("package", "prepayid="+prepayid);
...
//					+ "]");
	...
	public static void main(String[] args) {
		...
		resultMap = UnifiedOrder.weixinPrePay("2017051200000008", bigtotalAmount, description);
